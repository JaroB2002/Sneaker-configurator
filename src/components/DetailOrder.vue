...
<template>
  <div class="min-h-screen flex items-center justify-center bg-gray-100">
    <div class="w-full max-w-md p-6 bg-white rounded-md shadow-md">
      ...
      <div class="mb-4">
        ...
        <div class="flex items-center justify-between mb-4">
          ...
          <select
            ...
            class="w-2/3 p-2 border border-green-500 rounded text-green-500 focus:outline-none focus:border-green-500 focus:ring focus:ring-green-200"
          >
      ...
      <div class="text-center">
        <button @click="removeOrder" class="w-full p-2 bg-red-500 text-white rounded hover:bg-red-600">
          Remove Order
        </button>
