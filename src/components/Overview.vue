...
<template :class="{ 'theme-dark': dark }">
  ...
  <main class="h-full pb-16 overflow-y-auto">
    <div class="container grid px-6 mx-auto">
      <!-- With actions -->
      <h3 class="mb-6 text-2xl font-semibold text-gray-800 dark:text-gray-300">
        Order Dashboard
      </h3>
      <div class="mt-4">
          ...
          <div class="w-full px-6 sm:w-1/2 xl:w-1/3">
            <div class="flex items-center px-5 py-6 bg-69FF47 shadow-sm">
              ...
              <div class="mx-5 bg-69FF47">
                <h4 class="text-2xl font-semibold text-FFFFFF bg-69FF47">
                  {{ usersCount }}
                </h4>
      ...
      <span class="flex col-span-4 mt-2 sm:mt-auto sm:justify-end">
        <nav aria-label="Table navigation">
          <ul class="inline-flex items-center">
            <li>
              <button
                class="px-4 py-2 focus:outline-none focus:shadow-outline-purple"
                aria-label="Previous"
              >
                <svg
