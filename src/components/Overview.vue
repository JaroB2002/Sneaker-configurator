  ...
  <main class="h-full pb-16 overflow-y-auto">
    <div class="container grid px-6 mx-auto">
      ...
      <div class="mt-4">
          ...
          <div class="w-full sm:w-1/2 xl:w-1/3">
            <div class="flex items-center p-6 bg-white shadow-sm ">
              <div class="p-3 bg-green-400 bg-opacity-75 ">
                <svg class="w-8 h-8 text-white" viewBox="0 0 28 30" width="40px" height="40px" fill="none"
            ...
            <div class="flex items-center p-6 bg-white shadow-sm flex-1">
              ...
              <div class="ml-5">
                ...
                <div class="text-black">
                  ...
                  <router-link to="/settings" class="text-white-500 font-bold hover:underline">Go to
        ...
        <div class="flex flex-col items-center justify-flex-start min-h-screen bg-gray-100 text-gray-800 pb-8">
          ...
          <table class="w-11/12 bg-white shadow-md overflow-hidden mx-auto" style="table-layout: fixed">
            ...
            <tbody>
              <tr v-for="(shoe, index) in sortedShoes" :key="index"
                ...
                <td class="px-8 py-4 text-center">
                  <span class="px-3 py-1 font-semibold leading-tigh dark:text-white" :class="{
